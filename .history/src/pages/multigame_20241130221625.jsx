...
export default function MultiGame() {
  ...
  const initializeGame = () => {
    ...
    setFlippedCards([]);
    setGameEnded(false);
    setPlayer1Time(null); // Reset Player 1 time
    setPlayer2Time(null); // Reset Player 2 time
  ...
  const winner = () => {
    if (player1Time && player2Time) {
      if (player1Time < player2Time) return "Player 1 won!";
      else if (player2Time < player1Time) return "Player 2 won!";
      else return "Draw";
    }
    return "";
  };
