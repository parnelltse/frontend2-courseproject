    ...
    if (flippedCards.length === 1) {
      ...
      if (firstCard.image === secondCard.image) {
        ...
        setTimeout(() => {
          ...
          // Update score for the current player, ensuring it doesn't exceed 100
          if (currentPlayer === 1) {
            setPlayer1Score((prevScore) => (prevScore < 100 ? prevScore + 100 : 100));
          } else {
            setPlayer2Score((prevScore) => (prevScore < 100 ? prevScore + 100 : 100));
          }
