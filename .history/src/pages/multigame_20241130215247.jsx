...
export default function MultiGame() {
  ...
  return (
    <div className="single-game-container">
      ...
      {gameEnded ? (
        <div>
          {/* After both players are done, show each player's time taken */}
          <h2 className="congrat">
            First Player: {player1Time}s
            <br />
            Second Player: {player2Time}s
          </h2>
      ...
      {/* Display winner after both players finish */}
      {showWinnerScreen && (
        <div>
          <h2>{winner} Wins!</h2>
          <div className="game-controls">
